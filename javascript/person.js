...
goog.provide('proto.person.Person.EyeColour');

goog.require('jspb.BinaryReader');
goog.require('jspb.BinaryWriter');
goog.require('jspb.Message');
goog.require('proto.person.Date');
...
proto.person.Person.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    phoneNumberList: (f = jspb.Message.getRepeatedField(msg, 7)) == null ? undefined : f,
    eyeColour: jspb.Message.getFieldWithDefault(msg, 8, 0),
    birthday: (f = msg.getBirthday()) && proto.person.Date.toObject(includeInstance, f),
...
proto.person.Person.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 8:
      ...
      break;
    case 9:
      var value = new proto.person.Date;
      reader.readMessage(value,proto.person.Date.deserializeBinaryFromReader);
...
proto.person.Person.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      9,
      f,
      proto.person.Date.serializeBinaryToWriter
    );
  }
 ...
 * @return {!Array<string>}
 */
proto.person.Person.prototype.getPhoneNumberList = function() {
 ...
 * @return {!proto.person.Person} returns this
 */
proto.person.Person.prototype.setPhoneNumberList = function(value) {
 ...
 * @return {!proto.person.Person} returns this
 */
proto.person.Person.prototype.addPhoneNumber = function(value, opt_index) {
 ...
 * @return {!proto.person.Person} returns this
 */
proto.person.Person.prototype.clearPhoneNumberList = function() {
...
proto.person.Person.prototype.getBirthday = function() {
  return /** @type{?proto.person.Date} */ (
    jspb.Message.getWrapperField(this, proto.person.Date, 9));
};


/**
 * @param {?proto.person.Date|undefined} value
 * @return {!proto.person.Person} returns this
*/
